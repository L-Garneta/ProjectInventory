...
export function Purchasing() {
  // Halaman ini hanya untuk Admin (router sudah blok staff)
  return `
    <div class="page">
      <h1 class="page-title">Purchasing</h1>

      <div class="top-bar">
        <button id="btn-add" class="btn-primary-main">+ Tambah</button>
      </div>
  ...
  tbody.innerHTML = data
    .map(
      ...
      <tr>
        ...
        <td>
          <button class="btn btn-sm btn-outline-danger delete-btn" data-id="${p.id}">Hapus 🗑</button>
        </td>
      </tr>
    `,
    )
